...
const serialized_doc = {
	...
	nodes: {
	  ...
	  story_2: {
	    ...
	    description: {text: "The reference implementation uses only about 2000 lines of code. That means you'll be able to serve editable web pages, removing the need for a separate Content Management System.", annotations: [{start_offset: 100, end_offset: 118, node_id: 'link_1'}]},
	    buttons: []
	  },
	  story_3: {
	    id: 'story_3',
	  ...
	  image_grid_1: {
	    ...
	    type: 'image_grid',
	    layout: 1,
	    image_grid_items: ['image_grid_item_1', 'image_grid_item_2', 'image_grid_item_3', 'image_grid_item_4', 'image_grid_item_5', 'image_grid_item_6'],
	  },
	  story_4: {
	    id: 'story_4',
	    type: 'story',
	  ...
	  story_5: {
	    ...
	    description: {text: 'Integrate with your Svelte application. Use it as a template and copy and paste Svedit.svelte to build your custom rich content editor.', annotations: [{start_offset: 20, end_offset: 26, node_id: 'link_2'}, {start_offset: 80, end_offset: 93, node_id: 'emphasis_1'}]},
	    buttons: []
	  },
	  story_6: {
	    id: 'story_6',
	  ...
	  page_1: {
	    id: 'page_1',
	    type: 'page',
	    body: ['hero_1', 'heading_1', 'paragraph_1', 'story_1', 'story_2', 'image_grid_1', 'story_3', 'story_4', 'story_5', 'story_6', 'list_1', 'story_7'],
