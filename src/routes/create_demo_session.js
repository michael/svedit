...
const doc = {
  ...
  "nodes": {
    ...
    "story_1": {
      ...
      "buttons": [
        "nErVmcSTExeUewfewbRvWju",
        "uRHgZpdbDxagQHhvxcBDexH",
        "FyEnXJrqhQUrnrDmCfYhmdA",
        "KuaqEdzcDUJDyjfWzkPeEHt",
        "fjQhcWzJyTJCyyrdKMDjVkT"
      ]
    },
    "story_2": {
      "id": "story_2",
    ...
    "image_grid_item_1": {
      ...
      "title": {
        "text": "Svelte-native editing",
        "annotations": []
      },
      "description": {
        "text": "No mingling with 3rd-party rendering API's.",
        "annotations": []
      }
    },
    "image_grid_item_2": {
      ...
      "title": {
        "text": "Annotations are nodes, not marks",
        "annotations": []
      },
      "description": {
    ...
    "image_grid_item_3": {
      ...
      "title": {
        "text": "Graph‑first content with nested nodes",
        "annotations": []
      },
      "description": {
    ...
    "image_grid_item_4": {
      ...
      "title": {
        "text": "DOM ↔ model selections match",
        "annotations": []
      },
      "description": {
        "text": "Avoids flaky mapping layers found in other editors.",
        "annotations": []
      }
    },
    "image_grid_item_5": {
      ...
      "title": {
        "text": "Unicode‑safe, composition‑safe input",
        "annotations": []
      },
      "description": {
        "text": "Works correctly with emoji, diacritics, and CJK.",
        "annotations": []
      }
    },
    "image_grid_item_6": {
      ...
      "title": {
        "text": "Transactional editing with time travel",
        "annotations": []
      },
      "description": {
        "text": "Every change is safe and undoable.",
        "annotations": []
      }
    },
    "image_grid_1": {
